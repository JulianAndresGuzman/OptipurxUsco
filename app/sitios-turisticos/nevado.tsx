...
export default function NevadoDetails() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.title}>Nevado del Huila</Text>

      <Image
        source={require("../img/nevado-del-huila-img.jpg")}
        style={styles.image}
      />

      <Text style={styles.description}>
        El Nevado del Huila es un volcán nevado en la cordillera central, con ecosistemas de páramo
        y gran valor ambiental. Es una referencia natural del departamento.
      </Text>
